...
~function ($, angular) {
    ...
    angular.module("myApp").controller("capitalFlowCtrl", ["$scope", "$http", "$tip", function ($scope, $http, $tip) {
        ...
        $scope.requestApi = function (url, param) {
            url = url || "/pxy/capital/index?model=FundLog&type=all";
            param = param || {};
            $scope.url = url;
            $scope.param = param;
        ...
        $scope.getTypes = function () {
            $http.get("/pxy/capital/getType?model=FundLog").success(function (result) {
        ...
        $scope.export = function () {
            ...
            // 导出
            window.location.href = '/pxy/capital/export?model=FundLog&type=all&' + query;
        };
