...
!function ($) {
    ...
    Sidemenu.prototype.openLeftBar = function () {
            ...
            if (!$("#main").hasClass("enlarged")) {
                ...
                if ($(this).parent().hasClass("submenu")) {
                    if (!$(this).hasClass("active")) {
                        ...
                        $.cookie('currentTopMenu', $(this).attr("id"), {expires: 7, path: '/'});
                    }
                }
        ...
        Sidemenu.prototype.init = function () {
            var $this = this;
            // 获取cookie中的菜单(新增)
            var currentTopMenu = $.cookie('currentTopMenu');
            if (currentTopMenu) {
                var that = $("#" + currentTopMenu);
                if (!that.hasClass("active")) {
                    that.addClass("active");
                    that.parent().siblings().children("a").removeClass("active");
                }
            } else {
