! function(t, e) {
	"object" == typeof exports && "object" == typeof module ? module.exports = e(require("jQuery")) : "function" == typeof define &&
		define.amd ? define(["jQuery"], e) : "object" == typeof exports ? exports.busyLoad = e(require("jQuery")) : t.busyLoad =
		e(t.jQuery)
}(this, function(t) {
	return function(t) {
		function e(r) {
		...
		e.Component = function() {
			function t(e, n, i) {
				r(this, t), this._options = n, this._busyLoadOptions = i, this.setTag(e)
			}
			return i(t, [{
				key: "debugOptions",
				value: function() {
		...
		function r(t) {
			return "symbol" == typeof t || u(t) && i(t) == o
		}
		var i = n(9),
			u = n(25),
			o = "[object Symbol]";
		...
		function r(t) {
			return null == t ? void 0 === t ? s : a : A && A in Object(t) ? u(t) : o(t)
		}
		var i = n(7),
			u = n(23),
			o = n(24),
		...
		jQuery = n(64),
			function(t) {
				t.fn.busyLoad = r.busyLoad, t.busyLoadSetup = r.busyLoadSetup, t.busyLoadFull = r.busyLoadFull, t.fn.busyLoad.defaults =
					u.default
			}(jQuery)
		...
		function r(t) {
			$.extend(!0, s.default, t)
		}

		function i(t, e) {
			var n = new o.BusyLoad(this, JSON.parse(JSON.stringify(s.default)), e);
			switch (t) {
				case "show":
					n.show();
					break;
		...
		function u(t, e) {
			var n = $("body"),
				r = new o.BusyLoad(n, JSON.parse(JSON.stringify(s.default)), e);
			switch (t.toLowerCase()) {
				case "show":
					n.addClass("no-scroll"), r.caller = n, r.extendSettings({
						fullScreen: !0
					}), r.show();
					break;
				case "hide":
					r.hide(), n.removeClass("no-scroll")
			}
			return n
		}
		Object.defineProperty(e, "__esModule", {
			value: !0
		}), e.busyLoadSetup = r, e.busyLoad = i, e.busyLoadFull = u;
		var o = n(16),
			a = n(12),
			s = function(t) {
				return t && t.__esModule ? t : {
		...
		e.BusyLoad = function() {
			function t(e, n, i) {
				r(this, t), this._settings = n, this._caller = e, this.extendSettings(i)
			}
			return i(t, [{
				key: "debugSettings",
				value: function() {
				...
				value: function(t) {
					...
					if (this.caller.append(t), t.trigger("bl.show", [t, $(this.caller)]), A(this.settings, "animation", !1))
						switch (A(this.settings, "animation").toLowerCase()) {
							case "fade":
								t = t.fadeIn(A(this.settings, "animationDuration", "fast"), n);
								break;
							case "slide":
								t = t.slideDown(A(this.settings, "animationDuration", "fast"), n);
								break;
							default:
								throw "don't know animation: " + A(this.settings, "animation")
						} else t.show(0, n);
					return t
				}
			}, {
				...
				value: function(t) {
					...
					if (t.trigger("bl.hide", [t, $(this.caller)]), A(this.settings, "animation", !1)) switch (A(this.settings,
						"animation").toLowerCase()) {
						case "fade":
							t = t.fadeOut(A(this.settings, "animationDuration", "fast"), n);
							break;
						case "slide":
							t = t.slideUp(A(this.settings, "animationDuration", "fast"), n);
							break;
						default:
							throw "don't know animation: " + A(this.settings, "animation")
					} else t.hide(0, n)
				...
				key: "getOverlay",
				value: function() {
					return this._caller.data("busy-load-container") ? $("#" + this._caller.data("busy-load-container")) : (
						this._container = new u.Container(this._settings), this._containerItem = new o.ContainerItem(this._settings),
						A(this.settings, "text", !1) && (this._loadingText = new a.Text(this._settings), this._containerItem.tag
							.append(this._loadingText.tag)), !1 !== A(this.settings, "spinner", "pump") && (this._spinner = new s.Spinner(
							this._settings), this._containerItem.tag.append(this._spinner.tag)), this._container.tag.append(this._containerItem
							.tag).hide(), this._container.tag)
				}
			}, {
				...
				value: function(t, e) {
					if ("show" == e) {
						...
						"static" === this.caller.css("position") && this.caller.css("position", "relative"), this._caller.addClass(
							"busy-load-active"), t.attr("id", n), t = this.animateShow(t), this._caller.data("busy-load-container",
							n)
					} else this.animateHide(t), this._caller.removeData("busy-load-container"), this._caller.removeClass(
						"busy-load-active")
				}
			}, {
				key: "show",
		...
		e.Container = function(t) {
			function e(t) {
				return r(this, e), i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, "div", {
		...
		function r(t, e) {
			e = i(e, t);
			for (var n = 0, r = e.length; null != t && n < r;) t = t[u(e[n++])];
		...
		function r(t, e) {
			if (i(t)) return !1;
			var n = typeof t;
			return !("number" != n && "symbol" != n && "boolean" != n && null != t && !u(t)) || (a.test(t) || !o.test(t) ||
		...
		var r = n(27),
			...
			a = r(function(t) {
				var e = [];
				return i.test(t) && e.push(""), t.replace(u, function(t, n, r, i) {
		...
		var i = n(30),
			...
			a = n(54),
			s = n(55);
		r.prototype.clear = i, r.prototype.delete = u, r.prototype.get = o, r.prototype.has = a, r.prototype.set = s, t.exports =
			r
	}, function(t, e, n) {
		function r() {
		...
		function r(t) {
			return !(!o(t) || u(t)) && (i(t) ? d : A).test(a(t))
		}
		var i = n(34),
			u = n(35),
			o = n(11),
			...
			m = c.toString,
			p = q.hasOwnProperty,
			d = RegExp("^" + m.call(p).replace(s, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,
				"$1.*?") + "$");
		t.exports = r
	}, function(t, e, n) {
		function r(t) {
		...
		function r(t, e) {
			var n = this.__data__;
			return this.size += this.has(t) ? 0 : 1, n[t] = i && void 0 === e ? u : e, this
		}
		var i = n(2),
			u = "__lodash_hash_undefined__";
		t.exports = r
		...
		e.Text = function(t) {
			function e(t) {
				...
				return n.tag.css(o, a(t, "textMargin", ".5rem")), n
			}
			return u(e, t), e
		}(o.Component)
	}, function(t, e, n) {
		...
		e.Spinner = function(t) {
			...
			return u(e, t), o(e, [{
				...
				value: function() {
					this.options = {
						class: A(this._busyLoadOptions, "fontawesome", "fa fa-refresh fa-spin fa-2x fa-fw"),
						css: {
							color: A(this._busyLoadOptions, "color", "#fff")
						}
					}, this.setTag("span"), this.tag.addClass("busy-load-spinner-fontawesome"), this._$tag.append($(
						"<span/>", {
							class: "sr-only",
							text: "Loading ..."
						}))
				...
				key: "createCustomTag",
				value: function() {
					var t = A(this._busyLoadOptions, "custom");
				...
				value: function() {
					this.tag.css({
						"max-height": A(this._busyLoadOptions, "maxSize"),
						"max-width": A(this._busyLoadOptions, "maxSize"),
						"min-height": A(this._busyLoadOptions, "minSize"),
						"min-width": A(this._busyLoadOptions, "minSize")
					})
				}
			}]), e
		}(a.Component)
		...
		e.SpinnerLib = function() {
			function t(e) {
				...
				switch (r(this, t), this._busyLoadOptions = n, e.toLowerCase()) {
					case "pump":
						this.createPump();
						break;
					case "pulsar":
			...
			return i(t, [{
				...
				value: function() {
					this._spinner = $(
						...
						"background-color": u(this._busyLoadOptions, "color", "#333")
					})
				}
			}, {
