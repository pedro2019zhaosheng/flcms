...
class CmsAdType extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('cms_ad_type', array('engine' => 'MyISAM', 'comment' => '广告类型表'));
        $table->addColumn('name', 'string', array('default' => '', 'comment' => '广告类型名称'))
