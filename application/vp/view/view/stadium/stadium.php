<div class="container-fluid" ng-controller="newsCtrl">
            ...
            <div class="card mb-3">
                <div class="card-body pb-0 clearfix">
                    <div class="btn-group float-left">
                        <?php if(\app\common\model\AdminAuth::hasAuth('/vp/stadium/add')): ?>
                        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#news-add">添加场馆</button>
                        <?php endif; ?>

                        <?php if(\app\common\model\AdminAuth::hasAuth('/vp/stadium/setStatus')): ?>
                    ...
                    <div class="btn-group float-right">
                        <?php if(\app\common\model\AdminAuth::hasAuth('/vp/stadiumRecycle')): ?>
                        <a class="btn btn-sm btn-warning" href="/vp/stadiumRecycle" role="button">回收站</a>
                        <?php endif; ?>

                        <?php if(\app\common\model\AdminAuth::hasAuth('/vp/stadiumType')): ?>
                        <a class="btn btn-sm btn-primary" href="/vp/stadiumType" role="button">场馆类型</a>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="card-body pb-0">
                    <form class="form-inline pl-2">
                        <div class="form-group row">
                            ...
                            <label for="newsTitle">场馆名称:</label>
                            <input type="text" id="newsTitle" name="newsTitle" placeholder="请输入场馆名称" ng-model="newsTitle" class="form-control form-control-sm mx-sm-3">
                        </div>
                        ...
                        <table class="table table-bordered table-hover text-center">
                            ...
                            <tbody>
                             <tr ng-repeat="item in newsList" on-finish-render="ngRepeatFinished">
                                ...
                                <td ng-bind="item.stadium_type | default : '无'"></td>
                                <td><img ng-src="{{item.img | default : '' }}" style="width:2rem;height:2rem;" alt></td>
                                <td ng-bind="item.location | default : '无'"></td>
                                <td ng-bind="item.cost | default : '无'"></td>
                                <td ng-bind="item.linkman | default : '无'"></td>
                                <td ng-bind="item.tel | default : '无'"></td>
    ...
    <!--新增新闻模态框-->
    {include file="view/stadium/add" /}
    <!--修改新闻模态框-->
    {include file="view/stadium/update" /}
</div>
