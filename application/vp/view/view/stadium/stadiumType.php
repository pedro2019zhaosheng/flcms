<div class="container-fluid" ng-controller="newsTypeCtrl">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-12">
            <div class="card mb-3">
                <div class="card-body pb-0">
                    <div class="btn-group">
                        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#type-add">添加类型</button>
                ...
                <div class="card-body pb-0">
                    <form class="form-inline pl-2">
                        <div class="form-group row">
                            ...
                            <label for="newsType">类型名称：</label>
                            <input type="text" id="newsType" name="newsType" placeholder="请输入类型名称" ng-model="newsType" class="form-control form-control-sm mx-sm-3">
                        </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover text-center">
                            ...
                            <tbody>
                             <tr ng-repeat="item in newTypeList" on-finish-render="ngRepeatFinished">
                                    ...
                                    <div class="dropleft">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <ul class="list-group">
                                                ...
                                                <li ng-click="deleteType(item.id)" class="list-group-item dropdown-item cp text-danger">删除</li>
                                            </ul>
                                        </div>
                                    </div>
                                </td>
                        ...
                        {include file="public/nodata" nodata="newsTypeNoData"/}
                    </div>
    ...
    <!--新增新闻类型模态框-->
    {include file="view/stadium/addType" /}
    <!--修改新闻类型模态框-->
    {include file="view/stadium/updateType" /}
</div>
