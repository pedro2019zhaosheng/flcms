<!-- Modal -->
<div class="modal" id="agentCard-add" role="dialog" aria-labelledby="addAdminModalCenterTitle"
     aria-hidden="true">
                ...
                <div class="card-body">
                    <form>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
<!--                                <select class="form-control select2" id="bank_code{{item.id}}" name="bank_code">-->
...
<!--                                </select>-->
                                ...
                                <select class="form-control form-control-sm select2" id="bank_code{{item.id}}" name="bank_code">
                                    <option selected value="{{itemlist.code +'|'+itemlist.name}}" ng-bind="item.bank"></option>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-sm" ng-click="saveBankCard(agentid)">保存</button>
            </div>
        </div>
    </div>
</div>
