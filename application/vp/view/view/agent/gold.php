        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="operationPasswordG" class="col-sm-3 col-form-label"><sup class="text-danger">*</sup>操作密码</label>
                        <div class="col-sm-9">
                            <input type="password" class="form-control form-control-sm" id="operationPasswordG" autocomplete="new-password" placeholder="操作密码既是登陆密码" ng-model="operationPassword2">
                        </div>
                    </div>
                </form>
            </div>
             <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-sm" ng-click="reviseGold('',AgentId)">确定</button>
             </div>
        </div>
    </div>
</div>
