                ...
                <div class="card-body pb-0">
                    <form class="form-inline">
                        <div class="form-group">
                            <button type="button" class="btn btn-sm btn-primary mr-4" data-toggle="modal" data-target="#agent-return-add" ng-click="getaddAgentRebates()">添加代理商返点</button>
                        </div>
                    </form>
                </div>
                <div class="card-body pb-0">
                    <form class="form-inline col-sm-12">
                        ...
                        <div class="form-group row pl-3">
                            ...
                            <div class="mx-sm-3 form-control-sm">
                                <select class="form-control form-control-sm select2 col-sm-12" id="product" name="product">
                        ...
                        <div class="form-group row pl-3">
                            ...
                            <div class="mx-sm-3 form-control-sm">
                                <select class="form-control form-control-sm select2 col-sm-12" id="userstate" name="userstate">
                                    <option value="">请选择</option>
