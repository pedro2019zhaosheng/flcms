            ...
            <div class="modal-body">
                <form class="card-body">
                     <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" maxlength="11" class="form-control form-control-sm" id="addPhone" ng-model="addPhone" placeholder="请输入手机号">
                        </div>
                     </div>
                    <div class="form-group row">
                    ...
                    <div ng-repeat="lotteryList in lottery" on-finish-render="ngRepeatFinished">
                        <div class="form-group row">
                            <label for="rebate" class="col-sm-2 col-form-label px-1"><sup class="text-danger">*</sup><span ng-bind="lotteryList.name"></span></label>
                            <div class="col-sm-7">
