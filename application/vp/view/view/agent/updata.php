<!-- Modal -->
<div class="modal" id="updata-member" role="dialog" aria-labelledby="addAdminModalCenterTitle"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">修改代理商</h6>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-sm" ng-click="updataAgent()">保存</button>
            </div>
        </div>
    </div>
</div>
