        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-12">
            <div class="card mb-3">
                ...
                <div class="card-body pb-0">
                    <form class="form-inline pl-2">
                        <div class="form-group row">
                            <label for="startTime">提现日期:</label>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover text-center">
                            ...
                            <tr ng-repeat="(index, item) in adverList"><!--这里是提现记录返回数据-->
                                ...
                                <td>
                                    <span class="badge badge-secondary" ng-if="item.status === 1">待审核</span>
                                    <span class="badge badge-primary" ng-if="item.status === 2">提现中</span>
                                    <span class="badge badge-warning" ng-if="item.status === 3">已驳回</span>
                                    <span class="badge badge-success" ng-if="item.status === 4">提现成功</span>
                                    <span class="badge badge-danger" ng-if="item.status === 5">提现失败</span>
                                </td>
                                ...
                                <td>
                                    <div class="dropleft">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <ul class="list-group">
                                                <li class="list-group-item dropdown-item cp text-secondary" data-toggle="modal" data-target="#cash-detail" ng-click="getDetail(item.member_id, item.id)">
                                                    实名信息
                                                </li>
                                                <li ng-if="item.status === 1" class="list-group-item dropdown-item cp text-purple" data-toggle="modal" data-target="#cash-verify" ng-click="getVerify(item.id)">
                                                    提现审核
                                                </li>
                                            </ul>
                                        </div>
