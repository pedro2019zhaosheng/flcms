<div class="container-fluid" ng-controller="capitalRakeBackCtrl">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-12">
            <div class="card mb-3">
                ...
                <div class="card-body pb-0">
                    <form class="form-inline pl-2">
                        <div class="form-group row">
                            <label for="startTime">返佣日期:</label>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover text-center">
                            ...
                            <tbody>
                            <tr ng-repeat="(index, item) in rebateList"><!--这里是投注返佣记录返回数据-->
                                <td ng-bind="(rebateCurrentPage - 1) * rebatePerPage + index + 1"></td>
                                <td ng-bind="item.nick_name | default : '无'"></td>
                                <td ng-bind="item.chn_name | default : '无'"></td>
                                <td ng-bind="item.top_name | default : '无'"></td>
                                ...
                                <td ng-bind="item.bet_username | default : '无'"></td>
                                <td ng-bind="item.amount | currency : '￥'" class="text-danger"></td>
