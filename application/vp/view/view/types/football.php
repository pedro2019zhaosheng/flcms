<div class="container-fluid" ng-controller="footballCtrl">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-12">
            <div class="card mb-3">
                <div class="card-body pb-0">
                    <div class="btn-group">
                        <?php if(\app\common\model\AdminAuth::hasAuth('/vp/football/toggle')): ?>
                        <button type="button" ng-click="footballNormal(1)" class="btn btn-sm btn-success">批量开售</button>
                        <button type="button" ng-click="footballNormal(0)" class="btn btn-sm btn-warning">批量停售</button>
                        <?php endif; ?>

                        <?php if(\app\common\model\AdminAuth::hasAuth('/vp/football/delete')): ?>
                        <button type="button" ng-click="footballDel()" class="btn btn-sm btn-danger">批量删除</button>
                        <?php endif; ?>

                        <?php if(\app\common\model\AdminAuth::hasAuth('/vp/football/export')): ?>
                ...
                <div class="card-body pb-0">
                    <form class="form-inline col-sm-12">
                        <div class="form-group row">
                            <label for="footballState" class="col-form-label">出售状态：</label>
                            <select class="form-control mx-sm-3 form-control-sm select2" id="footballState" name="footballState">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover text-center">
                            ...
                            <tbody>
                                <tr ng-repeat="item in fbList" on-finish-render="ngRepeatFinished"><!--此处是竞彩足球列表数据-->
                                    ...
                                    <td>
                                        <div class="dropleft">
                                            ...
                                            <div class="dropdown-menu" role="menu" aria-labelledby="dropdownMenuButton">
                                                <ul class="list-group">
                                                    <?php if(\app\common\model\AdminAuth::hasAuth('/vp/football/detail')): ?>
                                                    <li class="list-group-item dropdown-item cp text-secondary" data-toggle="modal" data-target="#footballMatch" ng-click="matchDetail(item.match_num, item.league_name, item.host_name, item.guest_name)">赔率查看</li>
                                                    <?php endif; ?>

                                                    <?php if(\app\common\model\AdminAuth::hasAuth('/vp/football/save')): ?>
                                                    <li class="list-group-item dropdown-item cp text-primary" data-toggle="modal" data-target="#footballEdit" ng-click="matchEdit(item)">编辑赛果</li>
                                                    <?php endif; ?>
                        ...
                        {include file="public/nodata" nodata="footballNoData"/}
                    </div>
    ...
    {include file="view/types/footballMatch" /}
    {include file="view/types/footballEdit" /}
</div>
