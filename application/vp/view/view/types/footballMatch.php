<!-- Modal -->
<div class="modal" id="footballMatch" role="dialog" aria-labelledby="footballMatchModalCenterTitle" aria-hidden="true">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-hover text-center">
                            ...
                            <tr>
                                ...
                                <td ng-bind="rqspfNewest.D | default : '无'"></td>
                ...
                <div class="card mt-3 noshadow">
                                        ...
                                        <div class="card-body pt-1 px-3 pb-0">
                                            <table class="table table-bordered table-sm text-center">
                                                ...
                                                <tr ng-repeat="item in jqsVarIndex">
                                                    <td><small ng-bind="item.ut | toDate : 'MM/DD HH:mm'"></small></td>
                                                    <td><small ng-bind="item.dat.s0 | default : '无'"></small></td>
                                                    <td><small ng-bind="item.dat.s1 | default : '无'"></small></td>
                                                    <td><small ng-bind="item.dat.s2 | default : '无'"></small></td>
                                                    <td><small ng-bind="item.dat.s3 | default : '无'"></small></td>
                                                    <td><small ng-bind="item.dat.s4 | default : '无'"></small></td>
                                                    <td><small ng-bind="item.dat.s5 | default : '无'"></small></td>
                                                    <td><small ng-bind="item.dat.s6 | default : '无'"></small></td>
                                                    <td><small ng-bind="item.dat.s7 | default : '无'"></small></td>
                                                </tr>
                                                </tbody>
                                            </table>
                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-hover text-center">
                            ...
                            <tbody>
                            <tr>
                                <td ng-bind="jqsNewest.dat.s0 | default : '无'"></td>
                                <td ng-bind="jqsNewest.dat.s1 | default : '无'"></td>
                                <td ng-bind="jqsNewest.dat.s2 | default : '无'"></td>
                                <td ng-bind="jqsNewest.dat.s3 | default : '无'"></td>
                                <td ng-bind="jqsNewest.dat.s4 | default : '无'"></td>
                                <td ng-bind="jqsNewest.dat.s5 | default : '无'"></td>
                                <td ng-bind="jqsNewest.dat.s6 | default : '无'"></td>
                                <td ng-bind="jqsNewest.dat.s7 | default : '无'"></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
