<!-- Modal -->
<div class="modal" id="card-member" role="dialog" aria-labelledby="addAdminModalCenterTitle"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control form-control-sm select2" id="bank_code{{item.id}}" name="bank_code">
                                    <option ng-repeat="itemlist in bankList" ng-selected="{{item.bank_code == itemlist.code}}" value="{{itemlist.code}}" ng-bind="itemlist.name"></option>
                                </select>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-sm" ng-click="setCard(memberid,bankData)">保存</button>
            </div>
        </div>
    </div>
</div>
