<!-- Modal -->
<div class="modal" id="push-detail" role="dialog" aria-hidden="true">
                        ...
                        <table class="table table-bordered table-hover text-left">
                            ...
                            <tr>
                                <td class="text-danger">
                                    <b>起跟金额：
                                        <span ng-bind="betDetail.start_amount | default : '0.00'"></span>
                                        元
                                    </b>
                                </td>
                            </tr>
                            <tr>
                                <td class="text-danger">
                                    <b>跟单佣金：
                                        <span ng-bind="betDetail.follow_order_commission | default : '0.00'"></span>
                                        元
                                    </b>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="text-danger">
                                    <b>嘉奖彩金：
                                        <span ng-bind="betDetail.bounty | default : '0.00'"></span>
                                        元
                                    </b>
                                </td>
                            </tr>
                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-hover text-center">
                            ...
                            <tr>
                                ...
                                <td>金额：<b class="text-danger" ng-bind="body.extra.bei * 2"></b>元</td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                ...
                                <td>奖金：<b class="text-danger" ng-bind="body.extra.bonus | default : '0'"></b>元</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
