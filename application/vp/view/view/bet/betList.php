<div class="container-fluid" ng-controller="betListCtrl">
                ...
                <div class="card-body pb-0">
                    <form class="form-inline col-sm-12">
                        <div class="btn-group row">
                            <?php if(\app\common\model\AdminAuth::hasAuth('/vp/bet/export')): ?>
                        ...
                        <table class="table table-bordered table-hover text-center">
                            ...
                            <tr ng-repeat="item in betList"><!--此处是注单列表数据-->
                                ...
                                <td>
                                    ...
                                    <span ng-if="item.status === 1" class="badge badge-primary">
                                        <b>已出票</b>
                                    </span>
                                    ...
                                    <span ng-if="item.status === 4" class="badge badge-success">
                                        <b>已中奖</b>
                                    </span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="dropleft">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <ul class="list-group">
                                                <?php if(\app\common\model\AdminAuth::hasAuth('/vp/bet/info')): ?>
                                                <li class="list-group-item dropdown-item cp" ng-click="detail(item.id, item.code)">注单详情</li>
                                                <?php endif; ?>
                                                <li ng-if="item.code === 'JC'" class="list-group-item dropdown-item cp" ng-click="orderUpdate(item.id, item.code)">注单编辑</li>
                                            </ul>
                                        </div>
                                    </div>
                                </td>
    ...
    <!--注单编辑-->
    {include file="view/bet/sportUpdate" /}
</div>
