            ...
            <div class="modal-body">
                ...
                <form>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" maxlength="11" onkeyup="this.value = this.value.replace(/\D/gui, '')" class="form-control form-control-sm"  placeholder="请输入代理账号" ng-model="angentUserName">
                        </div>
                    </div>
                    <div class="form-group row">
