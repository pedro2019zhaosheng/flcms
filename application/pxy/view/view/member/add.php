<!-- Modal -->
<div class="modal" id="member-add" tabindex="-1" role="dialog" aria-labelledby="addAdminModalCenterTitle"
     aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <form>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" maxlength="11" placeholder="手机号" autocomplete="off" class="form-control form-control-sm" id="addUsername" ng-model="addUsername" oninput="value=value.replace(/[^\d]/g,'')">
                        </div>
                    </div>
                    <div class="form-group row">
