<!-- Modal -->
<div class="modal" id="recharge-modal" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form class="form-inline">
                    <label for="rechargeAmount" class="text-secondary">充值金额:</label>
                    <input id="rechargeAmount" type="text" class="form-control form-control-sm mx-sm-3" autocomplete="off" ng-model="rechargeAmount" placeholder="请输入充值金额">
                    <button type="submit" class="btn btn-primary btn-sm" ng-click="rechargeSave()">立即充值</button>
                </form>
            </div>
        </div>
    </div>
