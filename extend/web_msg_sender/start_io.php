    ...
    $inner_http_worker->onMessage = function($http_connection, $data){
        ...
        switch(@$_POST['type']){
            case 'publish':
                global $sender_io;
                $to = @$_POST['to'];
                // $_POST['content'] = htmlspecialchars(@$_POST['content']); 默认返回html, 修改底层代码, 返回json串
                $_POST['content'] = is_array(@$_POST['content']) ? json_encode(@$_POST['content'], JSON_UNESCAPED_UNICODE) : @$_POST['content'];
